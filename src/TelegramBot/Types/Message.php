...
use App\TelegramBot\Types\Payments\Invoice;
use App\TelegramBot\Types\Payments\SuccessfulPayment;
...
class Message extends BaseType implements TypeInterface
{
   ...
   *
   * @var \App\TelegramBot\Types\User
   */
  protected $from;
   ...
   *
   * @var \App\TelegramBot\Types\Chat
   */
  protected $chat;
   ...
   *
   * @var \App\TelegramBot\Types\Message
   */
   ...
   *
   * @var \App\TelegramBot\Types\Audio
   */
  protected $audio;
   ...
   *
   * @var \App\TelegramBot\Types\Document
   */
  protected $document;
   ...
   *
   * @var \App\TelegramBot\Types\Sticker
   */
  protected $sticker;
   ...
   *
   * @var \App\TelegramBot\Types\Video
   */
  protected $video;
   ...
   *
   * @var \App\TelegramBot\Types\Voice
   */
  protected $voice;
   ...
   *
   * @var \App\TelegramBot\Types\Contact
   */
  protected $contact;
   ...
   *
   * @var \App\TelegramBot\Types\Location
   */
  protected $location;
   ...
   *
   * @var \App\TelegramBot\Types\Venue
   */
  protected $venue;
   ...
   *
   * @var \App\TelegramBot\Types\Poll
   */
  protected $poll;
   ...
   *
   * @var \App\TelegramBot\Types\Dice
   */
  protected $dice;
   ...
   *
   * @var \App\TelegramBot\Types\Game
   */
  protected $game;
   ...
   * array of \App\TelegramBot\Types\User.
   *
   * @var array
   */
