...
use App\TelegramBot\Events\EventCollection;
...
class Client
{
  ...
  /**
   * @var \App\TelegramBot\BotApi
   */
  protected $api;

  /**
   * @var \App\TelegramBot\Events\EventCollection
   */
  protected $events;
  ...
  public function handle(array $updates)
  {
    foreach ($updates as $update) {
      /* @var \App\TelegramBot\Types\Update $update */
